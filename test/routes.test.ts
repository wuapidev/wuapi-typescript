...
const CASES: Case[] = [
  ...
  ["accounts.create historySync", (w) => w.accounts.create({ proxyLocation: { country: "VE", city: "caracas" }, historySync: "recent" }), "POST", `${B}/v1/accounts`, { proxyLocation: { country: "VE", city: "caracas" }, historySync: "recent" }],
  ["accounts.update historySync", (w) => w.accounts.update("acc_1", { historySync: "recent" }), "PATCH", A, { historySync: "recent" }],
